...
print(f"{'name':<30}{'exec_nbr':<10}{'exec_pts.':<10}{'exm_pts.':<10}{'tot_pts.':<10}{'grade':<5}")

# Output grades for each student
for student_id in students:
    if student_id in exercises and student_id in exam_points:
        first_name = students[student_id]['first']
        last_name = students[student_id]['last']
        ...
        total_points = total_exam_points + exercise_points
        grade = calculate_grade(total_exam_points, exercise_points)
        student = students[student_id]
        print(f"{name:<30}{completed_exercises:<10}{exercise_points:<10}{total_exam_points:<10}{total_points:<10}{grade:<5}")
